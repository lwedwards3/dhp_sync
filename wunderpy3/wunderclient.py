...
class WunderClient:
    ...
    def update_task(self, task_id, revision, list_id=None, title=None, assignee_id=None, completed=None, recurrence_type=None, recurrence_count=None, due_date=None, starred=None, remove=None):
        ''' 
        ...
        '''
        return tasks_endpoint.update_task(self, task_id, revision, list_id=list_id, title=title, assignee_id=assignee_id, completed=completed, recurrence_type=recurrence_type, recurrence_count=recurrence_count, due_date=due_date, starred=starred, remove=remove)
    ...
    def get_task_comments(self, task_id):
        ...
        '''
        return task_comments_endpoint.get_task_comments(self, task_id)

    def get_list_comments(self, list_id):
        ''' Gets all comments for the list with the given ID '''
        return task_comments_endpoint.get_list_comments(self, list_id)

    def get_comment(self, comment_id):
        ''' Gets information about the note with the given ID '''
        return task_comments_endpoint.get_task_comment(self, note_id)
    ...
    def get_task_files(self, task_id):
        ...
        A list containing none, one or more Comment-mapped objects
        '''
        return files_endpoint.get_task_files(self, task_id)

    def get_list_files(self, list_id):
        ''' Gets urls for all files for the list with the given ID '''
        return files_endpoint.get_list_files(self, list_id)
    ...
    def get_file_preview(self, file_id):
        ...
        return files_endpoint.get_file_preview(self, file_id) 
